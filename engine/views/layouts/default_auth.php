...
<!-- ############ LAYOUT START-->
  ...
  <?php
    if(isset($_SESSION['authorize']) and $_SESSION['access'] == 1) {
      require 'engine/views/components/navBar.php';
    }
  ?>
  ...
  <div id="content" class="app-content box-shadow-z2 bg pjax-container" role="main">
      <?php
        if($this->route['controller'] != 'project' or ($this->route['controller'] == 'project' and $this->route['action'] == 'index' and isset($this->route['id']))){
          require 'engine/views/components/topBar.php';
        }
      ?>

    <?php if($this->route['controller'] != 'project'): ?>
    <div class="app-footer white bg p-a b-t">
      <div class="pull-right text-sm text-muted">Version 1.0.0 BETA</div>
